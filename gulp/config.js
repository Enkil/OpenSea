module.exports = {
    ...
    pathTo: {
            Src: {
                ...
                PurifyCssHtml: ['dist/pages/**/*.html','dist/pages/**/*.js'],
                Jade: 'src/jade/**/*.jade',
                InlineCSS: 'dist/pages/emails/*.html',
            ...
            Build: {
                ...
                Html: 'dist/',
                InlineCSS: 'dist/pages/emails/',
                WatchInlineCSS: 'dist/pages/emails/*.html',
                Images: 'dist/img',
    ...
    StyledoccoOptions:"./node_modules/styledocco/bin/styledocco -o dist/docs/scss -s src/scss src/scss",
